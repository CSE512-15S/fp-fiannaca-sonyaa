...
function DrawNode(d, i) {
    ...
    //TODO: Come up with a better way to handle the node scaling
 ...
 */
function Renderer(selector, config) {
...
Renderer.prototype.UpdateNodes = function() {
    ...
    // Update set
    //TODO: Come up with a better way to handle the translation to center the nodes
    nodes.attr('transform', function(d) {return 'translate(' + (d.x - 40) + ',' + (d.y - 40) + ')';});
    ...
    var node = nodes.enter()
        ...
        .attr('transform', function(d) {return 'translate(' + (d.x - 40) + ',' + (d.y - 40) + ')';})

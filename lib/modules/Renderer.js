...
function Renderer(flowviz) {
    ...
    drag = d3.behavior.drag()
        ...
        .on(fv.Interactions.GetDomEvent("MoveNode"), fv.Interactions.GetFunc("MoveNode"));
...
function DrawEdgeRegion(d, i) {
    d3.select('path#flow-edge-region-' + i)
        ...
        .on(fv.Interactions.GetDomEvent("ChangeEdge"), fv.Interactions.GetFunc("ChangeEdge"));
}
...
Renderer.prototype.RenderEdges = function() {
    ...
    var arrow = edges.enter()
        ...
        .on(fv.Interactions.GetDomEvent("TouchEdge"), fv.Interactions.GetFunc('TouchEdge'));
...
Renderer.prototype.RenderNodes = function() {
    ...
    var node = nodes.enter()
        ...
        .on(fv.Interactions.GetDomEvent("StartConnection"), fv.Interactions.GetFunc("StartConnection"))
        .on(fv.Interactions.GetDomEvent("TouchNode"), fv.Interactions.GetFunc("TouchNode"))
        .each(DrawNode);

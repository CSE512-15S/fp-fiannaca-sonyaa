 ...
 * GraphManager module.
 *
 * @param viz A d3 selection for the root node of the visualization
 * @param config (ConfigParser) The config parser object
 *
 ...
 *
 * @param list A list of the nodes
 */
 ...
 *
 * @param list A list of the edges
 */

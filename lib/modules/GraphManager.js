...
function GraphManager(renderer, layout, config) {
    ...
    this.AddNode(types[0], 0, 300, false);
    this.AddNode(types[1], 300, 0, false);
    this.AddNode(types[2], 600, 300, false);
...
GraphManager.prototype.AddNode = function(type, x, y, update) {
    ...
    if(update === true) this.renderer.Update();
};
...
GraphManager.prototype.StartConnection = function(node, x, y) {
    ...
    this.tmpNode = new FlowNode(NodeType.GetDummy(), x, y, this);

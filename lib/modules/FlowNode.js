 ...
 */
function FlowNode(nodeType, x, y, man) {
    this.type = nodeType;

    this.x = x;
    this.y = y;

    // How far should the edge be translated to actually be at the center of this node?
    ...
    // How far should the edge be set back from the center of this node?

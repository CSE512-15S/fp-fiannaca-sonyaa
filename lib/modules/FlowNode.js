 ...
 * @param {boolean}     [isTemporary=false] Indicates if this is a temporary node used when initially connecting two nodes
 *
 * @constructor Simply sets parameters for the time being.
 */
function FlowNode(nodeType, x, y, man, isTemporary) {

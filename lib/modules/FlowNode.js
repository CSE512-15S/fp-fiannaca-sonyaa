...
FlowNode.prototype.SetDataItem = function(key, value) {
    if(this.DataItems.hasOwnProperty(key)) {
        ...
        if(this.DataItems[key].hasOwnProperty("validator")) {
            ...
            if (fv.App.Callbacks.Validators.hasOwnProperty(name)) {
                if (!fv.App.Callbacks.Validators[name](this.DataItems[key].value, value)) {
                ...
                console.error("Validator function " + this.DataItems[key].validator + " not implemented!");
            }
        }

...
/**
 * TODO: Complete the autocomplete feature!
 *
 *       This should determine two things:
 *         1) Which nodes are required to be connected to this node for the graph to be complete?
 *         2) Which nodes could possibly be connected to this node but are not required?
 *
 *       Given the answers to these two questions, this data needs to be passed off to the renderer so that the node
 *       options can be displayed to the screen.
 */

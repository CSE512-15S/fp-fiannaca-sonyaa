...
FlowEdge.prototype.getTip = function(dir) {
    var bottomX, bottomY;
    console.log(dir);

    if(dir === module.exports.FORWARD) {
        bottomX = this.endPt.x - arrHeight * this.dx;
        bottomY = this.endPt.y - arrHeight * this.dy;

        return [{
            x: bottomX + this.dy * arrWidth,
            y: bottomY - this.dx * arrWidth
        },{
            x: this.endPt.x,
            y: this.endPt.y
        },{
    ...
    } else if(dir === module.exports.BACKWARD) {

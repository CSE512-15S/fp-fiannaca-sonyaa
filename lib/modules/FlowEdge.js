...
FlowEdge.prototype.Update = function() {
    if(this.direction === FlowEdge.FORWARD) this.dirOffset = 10;
    if(this.direction === FlowEdge.BACKWARD) this.dirOffset = -10;
    ...
    if(this.dirOffset > 0) {
        //var pt = {
        //    x: (this.start.x  + ((this.end.x - this.start.x) * this.dx)) + this.dy * (this.dirOffset),
        //    y: (this.start.y + ((this.end.y - this.start.y) * this.dy)) - this.dx * (this.dirOffset)
        //};
        //
        //this.points.push(pt);
